#############################################################################
# Makefile for building: bin/FA_Uploader
# Generated by qmake (3.0) (Qt 5.4.1)
# Project:  FA_Uploader.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile FA_Uploader.pro
#############################################################################
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		FA_Uploader.pro  src/web/WebManager.cpp \
		src/main.cpp
QMAKE_TARGET  = FA_Uploader
DESTDIR       = bin/#avoid trailing-slash linebreak
TARGET        = bin/FA_Uploader
...
Makefile: FA_Uploader.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile FA_Uploader.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/web/WebManager.cpp src/main.cpp $(DISTDIR)/
...
WebManager.o: src/web/WebManager.cpp src/web/WebManager.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o WebManager.o src/web/WebManager.cpp

main.o: src/main.cpp src/web/WebManager.h
